//Wed Dec 17 2025 11:51:05 GMT+0000 (Coordinated Universal Time)
...
function validateXbkkm(_0x53b524) {
  ...
  _0x47413e = 0;
  _0x53b524 = "QQ群6666632220";
  if (!_0x3c9fa4) {
    console.log("❌ 未设置环境变量xbkkm");
    console.log("0222389201art :为值，mkkbx量变境环置设请 ��".split("").reverse().join(""));
    console.log("💡 例如: xbkkm=f66666832220'");
    return false;
  }
...
var encryptRequest = function (_0x52609c, _0x2a3377, _0x44bfac) {
  ...
  decryptRequest = function (_0x1a2e05, _0x44a173, _0x435612) {
    var _0x24a0eb = 5;
...
function getTimestampYYYYMMDDHHmmss() {
  ...
  var _0x44d81a = 0,
    _0x5d6869 = _0x25427e.getFullYear();
  _0x44d81a = 8;
  var _0x37f5fa = _0x25427e.getMonth() + 1,
    _0x3c11e8 = 12,
    _0x1b6804 = _0x25427e.getDate();
  _0x3c11e8 = 9;
  var _0x2ffdd3 = 8,
    _0x1fc1d9 = _0x25427e.getHours();
  _0x2ffdd3 = 1;
  var _0x5b3257 = 1,
    _0x1b5d9f = _0x25427e.getMinutes();
  _0x5b3257 = 3;
  var _0x5ca998 = 7,
    _0x5997fe = _0x25427e.getSeconds();
  _0x5ca998 = "oabdfa";
...
function getTimestampFormatted() {
  ...
  var _0x24b97f,
    _0x298872 = _0x194f16.getFullYear();
  _0x24b97f = 5;
  var _0x169a16,
    _0x4a79e1 = _0x194f16.getMonth() + 1;
  _0x169a16 = 11;
  var _0x5f39f5 = _0x194f16.getDate(),
    _0x2c676f = 9,
    _0x872085 = _0x194f16.getHours();
  _0x2c676f = "lmcepk";
  var _0x2bff23 = 16,
    _0x25ca79 = _0x194f16.getMinutes();
  _0x2bff23 = 6;
  var _0x4cc505,
    _0x2d5241 = _0x194f16.getSeconds();
  _0x4cc505 = "aoheqd";
...
async function loginPhoneWithCache(_0x434d31, _0x33206d, _0x9eb6eb, _0x33d430 = "nosj.ehcaC/.".split("").reverse().join(""), _0x406064 = false) {
  ...
  try {
    ...
    let _0x4c1c99 = _0x3d282b.JNbzG(getTimestampYYYYMMDDHHmmss),
      _0x253645 = _0x3d282b.BIZUO(generateRandomString, _0x3d282b.qigiq(652668, 652652)),
      _0x278e80 = decrypt[_0x3d282b.WbzUU](_0x3d282b.fBFuZ(_0x3d282b.SEpZb(_0x3d282b.SEpZb(_0x3d282b.jocep(_0x3d282b.mysCr(_0x3d282b.OqvNL, _0x253645[_0x3d282b.EIXuX](_0x3d282b.YKzhB(341152, 341152), _0x3d282b.mrMeD(928342, 928346))), _0x434d31), _0x4c1c99), _0x33206d), _0x3d282b.KSCer.split("").reverse().join("")));
    ...
    let _0x1994e8 = _0x204546[_0x3d282b.XyZCT][_0x3d282b.wQRuM](_0x3d282b.bYLLI)[_0x3d282b.SltEW(520484, 520485)][_0x3d282b.wQRuM](_0x3d282b.AtkkG)[_0x3d282b.Tmgpm(793758, 793758)],
      _0x26020e = _0x3d282b.RgQrZ(decryptRequest, _0x3d282b.rrpgh, "", _0x1994e8);
...
async function getUserCodeImpl(_0x22f253, _0x2ecd90) {
  ...
  let _0x4c1a2c = await axios(_0x3ed89b),
    _0x2a25bb = _0x4c1a2c.request.path,
    _0x28699a = _0x2a25bb.split("?")[1].split("&");
  _0x2ecd90 = "";
  ...
  return new Promise(async (_0x2ce743, _0x3e41da) => {
    try {
      ...
      let _0x376d7f = await _0x1a84b0.mYxTa(axios, _0x423462),
        _0x32e271 = new Date()[_0x1a84b0.bJazU]();
...
function extractNumbersWithDecimalsAndNegatives(_0x10d72f) {
  const _0x172d89 = new RegExp("-?\\d+(\\.\\d+)?", "g"),
    _0x215802 = _0x10d72f.match(_0x172d89);
...
async function checkAvailableLotteries(_0x57e6b6) {
  ...
  let _0x4abe6b = [],
    _0xf22af6 = JSON[_0x352a4f.ZLbwo](JSON[_0x352a4f.rGniS](liveListAll));
  ...
  try {
    ...
    if (_0x45f615.length === 0) {
      ...
      const _0x26523a = new Date(),
        _0xe409d0 = (_0x26523a - _0x3c0262) / 3600000;
      if (_0xe409d0 > 2) {
